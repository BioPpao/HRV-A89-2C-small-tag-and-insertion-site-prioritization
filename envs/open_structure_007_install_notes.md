...
.tools/envs/open_structure_007/bin/pip install --no-cache-dir 'dm-haiku==0.0.10' 'pandas<2.0.0,>=1.3.4' 'absl-py<2.0.0,>=1.0.0' 'importlib-metadata<5.0.0,>=4.8.2' 'protobuf<5.0.0,>=3.20.3' 'keras<2.13,>=2.12.0' 'typing-extensions<4.6.0,>=3.6.6'
...
- `dm-haiku 0.0.17` expects newer JAX APIs than ColabFold 1.5.3/JAX 0.4.14, while `dm-haiku 0.0.9` still references removed `jax.xla`; `dm-haiku 0.0.10` was the compatible tested version.
