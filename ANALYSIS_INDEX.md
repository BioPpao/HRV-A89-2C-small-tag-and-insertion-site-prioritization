...
| Current execution task | `tasks/BROAD_DYNAMICS_AND_RECOVERY_009.md` | **AUTHORIZED / CURRENT** | resolve 008 technical gaps, rebalance candidate panel, run broad replicated comparative dynamics |
...
CANDIDATE_PANEL_EXPANSION_008                             COMPLETE
  ...
  └─ diversified draft panel
        ↓
BROAD_DYNAMICS_AND_RECOVERY_009                           CURRENT
  ├─ resolve 248|249×HA OpenMM NaN
  ├─ recover disorder layer
  ├─ run local tagged dimer/trimer accommodation
  ├─ focused PA14/AGIA structure screen
  ├─ rebalance site/tag dynamics panel
  ├─ replicated comparative MD on A89 2C 112–321
  ├─ tag exposure/contact/convergence analysis
  ├─ dynamic correlation/network analysis
  └─ revise Tier A / Tier B / controls
        ↓
